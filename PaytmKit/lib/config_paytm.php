...
if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	//Change this constant's value with Merchant key received from Paytm.
	$PAYTM_MERCHANT_MID 		= "DIY12386817555501617"; // <- Change******
	$PAYTM_MERCHANT_KEY 		= "bKMfNxPPf_QdZppa"; //<- Change******

	$PAYTM_CHANNEL_ID 		= "WEB";
	$PAYTM_INDUSTRY_TYPE_ID = "Retail";
	$PAYTM_MERCHANT_WEBSITE = "DIYtestingweb"; //<- Change******

	$PAYTM_CALLBACK_URL 	= "http://localhost/PROJECT/iSchoolLearningManagement/PaytmKit/pgResponse.php";
}
